...
public class GV_SuaForm extends javax.swing.JDialog {

    public GV_SuaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GV_SuaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GV_SuaForm dialog = new GV_SuaForm(new javax.swing.JFrame(), true);
