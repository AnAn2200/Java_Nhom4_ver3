...
public class SV_XemThanhVien extends javax.swing.JFrame {

    public SV_XemThanhVien() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cboSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A->Z", "Z->A", "A->B" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(cboSapXep, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(17, 17, 17))
        );
...
//        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SV_XemThanhVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SV_XemThanhVien().setVisible(true);
            }
        });
    }
